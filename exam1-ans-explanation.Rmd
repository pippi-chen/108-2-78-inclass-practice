...
```{r}
chinese1to9 <- c('一','二','三','四','五','六','七','八','九')
sample(chinese1to9,size=300,replace=T) ->
  receipts300chinese
head(receipts300chinese)
```
...
# poem_song
```
list(poem_song[[4]],poem_song[[1]],poem_song[[2]],.....)

poem_song[c(4,1,2,3,6,...)]
